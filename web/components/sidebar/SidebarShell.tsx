...
export function SidebarShell({
  ...
  const brandAlt = t("伴读 Bandu");
  const brandPrimary = t("伴读");
  const brandSecondary = t("Bandu");
  ...
  if (collapsed) {
    return (
      <aside className="flex w-[56px] h-screen shrink-0 flex-col items-center border-r border-[var(--border)]/70 bg-[var(--secondary)] py-3 transition-all duration-200">
        <button
  ...
  /* ---- Expanded state ---- */
  return (
    <aside className="flex h-screen w-[232px] shrink-0 flex-col border-r border-[var(--border)]/70 bg-[var(--secondary)]/92 backdrop-blur transition-all duration-200">
      {/* Header: logo + collapse toggle */}
      <div className="flex h-14 items-center justify-between px-4">
        <Link href="/" className="flex items-center gap-3">
          <div className="flex h-11 w-11 items-center justify-center">
            <img
              src="/bandu-app-icon.png"
              alt={brandAlt}
              width={44}
              height={44}
              className="h-11 w-11 object-contain drop-shadow-[0_2px_8px_rgba(45,125,210,0.18)]"
            />
          </div>
          <div className="leading-none">
            <span className="block text-[14px] font-semibold tracking-[0.08em] text-[var(--foreground)]">
              {brandPrimary}
            </span>
            <span className="mt-1 block text-[10px] uppercase tracking-[0.24em] text-[var(--muted-foreground)]">
              {brandSecondary}
            </span>
          </div>
        </Link>
